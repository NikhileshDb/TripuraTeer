...
from .serializers import CommonNumberSerializer, FirstRoundSerializer, SecondRoundSerializer, SundayResultSerializer, WednesdayResultSerializer, DailyResultSerializer
from daily.models import CommonNumber, FirstRound, SecondRound, DailyResult
...
class CommonNumberViewSet(viewsets.ModelViewSet):
    serializer_class = CommonNumberSerializer
    queryset = CommonNumber.objects.all().order_by('-date')
